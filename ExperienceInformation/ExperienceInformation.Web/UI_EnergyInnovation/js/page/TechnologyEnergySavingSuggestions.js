...
function initPageAuthority() {
    $.ajax({
        type: "POST",
        url: "TechnologyEnergySavingSuggestions.aspx/AuthorityControl",
        data: "",
...
function VieweEnergySavingSuggestionsTextFun(mySuggestionsId, myTitle, myPropounder, myProposedTime) {
    ...
    $.ajax({
        type: "POST",
        url: "TechnologyEnergySavingSuggestions.aspx/GetEnergySavingSuggestionsTextById",
...
function ModifyEnergySavingSuggestionsFun(mySuggestionsId) {
    ...
    $.ajax({
        type: "POST",
        url: "TechnologyEnergySavingSuggestions.aspx/GetEnergySavingSuggestionsInfoById",
        data: "{mySuggestionsId:'" + mySuggestionsId + "'}",
        contentType: "application/json; charset=utf-8",
        dataType: "json",
        success: function (msg) {
...
function DeleteEnergySavingSuggestionsFun(mySuggestionsId) {
    ...
    parent.$.messager.confirm('询问', '您确定要删除该工艺节能挖潜建议?', function (r) {
        if (r) {
            $.ajax({
                type: "POST",
                url: "TechnologyEnergySavingSuggestions.aspx/DeleteEnergySavingSuggestionsById",
                data: "{mySuggestionsId:'" + mySuggestionsId + "'}",
                contentType: "application/json; charset=utf-8",
                dataType: "json",
                success: function (msg) {
...
function SaveEnergySavingSuggestionsFun() {
    ...
    if (AddEnergySavingSuggestionsFlag == 1) {
        $.ajax({
            type: "POST",
            url: "TechnologyEnergySavingSuggestions.aspx/AddEnergySavingSuggestions",
        ...
        $.ajax({
            type: "POST",
            url: "TechnologyEnergySavingSuggestions.aspx/ModifyEnergySavingSuggestions",
