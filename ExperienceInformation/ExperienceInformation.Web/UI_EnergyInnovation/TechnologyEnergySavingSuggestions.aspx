<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TechnologyEnergySavingSuggestions.aspx.cs" Inherits="ExperienceInformation.Web.UI_EnergyInnovation.TechnologyEnergySavingSuggestions" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="js/page/TechnologyEnergySavingSuggestions.js" charset="utf-8"></script>
            ...
            <table>
                ...
                <tr>
                    <td>
                        <table>
                            <tr>
                                <td><a id="id_add" href="#" class="easyui-linkbutton" data-options="iconCls:'icon-add',plain:true" onclick="AddEnergySavingSuggestionsFun();">添加</a>
                                </td>
                                <td>
